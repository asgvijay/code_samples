...
if(!($stmt = $mysqli->prepare("INSERT INTO house(street_number, street_name, zip_code) VALUES (?, ?, ?)"))){
	echo "Prepare failed: "  . $stmt->errno . " " . $stmt->error;
}
if(!($stmt->bind_param("ssi",$_POST['street_number'],$_POST['street_name'],$_POST['zip_code']))){
