...
public class DeleteBiz extends AppCompatActivity {

    ProgressBar progressBar;

    static final String DELETE_URL = "https://kumar-cs496-a3.appspot.com/delete/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete_biz);
        ...
        SubmitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new submitDelete().execute(bizName.getText().toString()+
                        "/"+ zipC.getText().toString());
            }
        });
        ...
        HomeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DeleteBiz.this, InBizzie.class);
    ...
    class submitDelete extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... param) {
            ...
            try {
                URL url = new URL(DELETE_URL + param[0]);
